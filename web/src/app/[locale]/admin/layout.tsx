    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-center justify-between p-4 border-b border-border dark:border-white/10">
            {!collapsed && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-bold text-sm">{t("clubManagement")}</h2>
                  <p className="text-xs text-muted-foreground">관장 전용</p>
                </div>
              </div>
            )}
            <Button
                  ...
                  {!collapsed && (
                    <span>
                      {item.key === "dashboard"
                        ...
                        : item.key === "payments"
                        ? t("payments.title")
                        : item.key === "exchangeMatch"
                        ? t("exchangeMatch.title")
                        : item.key === "chat"
                        ? t("chat.title")
      ...
      >
        ...
        <div className="sticky top-16 z-30 flex items-center gap-4 glass border-b border-border dark:border-white/5 p-4 md:hidden">
          ...
          <h1 className="font-semibold">{t("clubManagement")}</h1>
        </div>
